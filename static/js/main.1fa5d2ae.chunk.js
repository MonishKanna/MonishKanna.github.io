(this.webpackJsonpportfolio = this.webpackJsonpportfolio || []).push([
  ...
  Array(24).concat([
    function (e, t, a) {
      var l = {
        "./Duke_logo.png": 89,
        "./Monish_Kanna_Suresh_Photo.jpg": 90,
        "./Tableau.png": 91,
        "./address_image.svg": 92,
        "./animated_logo.svg": 93,
        "./blogs_image.svg": 94,
        "./bonbloc.png": 95,
        "./cloud_infrastructure.svg": 96,
        "./codeInLogo.png": 97,
        "./contactMail.png": 98,
        "./coursera_logo.png": 99,
        "./data_science.svg": 100,
        "./datacamp.png": 101,
        "./deeplearning_ai_logo.png": 102,
        "./delhivery_logo.png": 103,
        "./developerActivity.svg": 104,
        "./digital_terrain.png": 105,
        "./dsc_logo.png": 106,
        "./education.svg": 107,
        "./experience.svg": 108,
    ...
    function (e) {
      e.exports = JSON.parse(
        '{"data":[{"id":"R_kgDOJWL0-g","name":"Android Health Check","createdAt":"2023-12-10","url":"https://github.com/MonishKanna/Android-Health-Check","description":"\ud83e\udde8 Developed predictive models for Android malware detection using dimensionality reduction and advanced classification algorithms, ensuring precise health classification.","isFork":false,"languages":[{"name":"Python","iconifyClass":"logos-python"},{"name":"Jupyter Notebook","iconifyClass":"logos-jupyter"}]},{"id":"R_kgDOG_vYHA","name":"Exploring Mental Health","createdAt":"2024-12-01","url":"https://github.com/MonishKanna/Exploring-Mental-Health","description":"\ud83d\ude80 Developed machine learning models to predict depression based on factors like work pressure and sleep duration, achieving high accuracy with XGBoost and Random Forest classifiers","isFork":false,"languages":[{"name":"Python","iconifyClass":"logos-python"},{"name":"Jupyter Notebook","iconifyClass":"logos-jupyter"}]},{"id":"MDEwOlJlcG9zaXRvcnkyNDU0NjcyNzQ=","name":"Amazon Prime Video Insights","createdAt":"2024-01-03","url":"https://public.tableau.com/app/profile/monish.kanna.suresh/viz/Amazon_Prime_Dataset/AmazonPrime?publish=yes","description":"\ud83d\udd25 Created an interactive Tableau dashboard for Amazon Prime Video (2000-2022) to visualize key industry insights, including TV/movie ratios, top genres, production countries, and ratings.","isFork":false,"languages":[{"name":"Tableau","iconifyClass":"logos:tableau"}]},{"id":"R_kgDOG0_8uQ","name":"Facial Keypoints Detection","createdAt":"2023-05-11","url":"https://github.com/MonishKanna/Facial-Checkpoints-Detection","description":"\ud83c\udf00 Developed CNN model to accurately identify facial landmarks, improving performance through data preprocessing and model optimization.","isFork":false,"languages":[{"name":"Python","iconifyClass":"logos-python"}]},{"id":"R_kgDOGcPKSQ","name":"Vaccine Optimization Analysis","createdAt":"2023-05-20","url":"https://github.com/MonishKanna/Covid-Vaccine-Optimization-Analysis","description":"\ud83d\udc89 Optimized vaccine distribution using linear programming to minimize unvaccinated populations, considering vaccine supply and key demographic data","isFork":false,"languages":[{"name":"Python","iconifyClass":"logos-python"}]},{"id":"MDEwOlJlcG9zaXRvcnkzMjU5NDM1MTE=","name":"Emotion Based Music Recommender","createdAt":"2022-12-15","url":"https://github.com/MonishKanna/Emotion-Based-Music-Recommender","description":"\ud83c\udfa7 Developed a deep learning model for personalized music recommendations by analyzing real-time emotions through facial expression classification using a CNN, categorizing emotions into seven distinct types.","isFork":false,"languages":[{"name":"Python","iconifyClass":"logos-python"}]}]}'
      );
    },
    ,
    function (e, t, a) {
    ...
    function (e, t, a) {},
    function (e, t, a) {
      e.exports = a.p + "static/media/Duke_logo.00e92d55.png";
    },
    function (e, t, a) {
      e.exports = a.p + "static/media/Monish_Kanna_Suresh_Photo.f33a7d95.jpg";
    },
    function (e, t) {
      e.exports =
        "data:image/png;base64,";
    },
    function (e, t, a) {
    ...
    function (e, t) {
      e.exports =
        "data:image/png;base64,";
    },
    function (e, t, a) {
    ...
    function (e, t) {
      e.exports =
        "data:image/png;base64,";
    },
    function (e, t, a) {
    ...
    function (e, t, a) {
      e.exports = a.p + "static/media/digital_terrain.3c078f3d.png";
    },
    function (e, t, a) {
    ...
    function (e, t, a) {
      e.exports = a.p + "static/media/genome.4a1ab1be.png";
    },
    function (e, t, a) {
    ...
    function (e, t, a) {
      e.exports = a.p + "static/media/magzter.b5da7c57.png";
    },
    function (e, t, a) {
    ...
    function (e, t, a) {
      e.exports = a.p + "static/media/ssn.67c8a085.webp";
    },
    function (e, t, a) {
      e.exports = a.p + "static/media/stevens_logo.03b5a61c.png";
    },
    function (e, t, a) {
    ...
    function (e, t, a) {
      e.exports = a.p + "static/media/udemy.453a56d7.png";
    },
    function (e, t, a) {
      e.exports = a.p + "static/media/ui_ux_design.d6363089.svg";
    },
    function (e, t, a) {
      e.exports = a.p + "static/media/uofmichigan.fc825e9e.png";
    },
    function (e, t, a) {
      e.exports = a.p + "static/media/vkills.5b37f8ae.png";
    },
    function (e, t, a) {},
    function (e, t, a) {},
    function (e, t, a) {},
    ...
    function (e, t, a) {
      ...
      const C = !1,
        ...
        p = {
          ...
          subTitle:
            "A passionate data scientist who thrives on building end-to-end solutions, leveraging data to develop scalable and sustainable systems that drive impactful insights and decision-making.",
          resumeLink:
            "https://drive.google.com/file/d/1Ve8zBtMcQbgKDFcN_OeWzHsCX6DMrL60/view?usp=drive_link",
          portfolio_repository:
            "https://github.com/MonishKanna/masterPortfolio",
              ...
              experiences: [
                {
                  ...
                  location: "Chennai, Tamil Nadu, India",
                  description:
                    "\u26a1 Conducted A/B testing initiatives for marketing and customer engagement campaigns, designing controlled experiments using Bayesian inference and multivariate testing, delivering insights that improved conversion rates by 22% and enhanced user segmentation strategies.",
                  color: "#000000",
                },
                {
                  title: "Software Engineer Intern",
      ...
      var S = function () {
        ...
        const b = {
          ...
          url:
            null === f || void 0 === f || null === (l = f.og) || void 0 === l
              ...
              : l.url,
          email: E,
          telephone: null === (r = Z) || void 0 === r ? void 0 : r.subtitle,
          sameAs: C,
          jobTitle: y.title,
          ...
          address: {
            "@type": "PostalAddress",
            addressLocality:
              null === (i = v) || void 0 === i ? void 0 : i.locality,
            addressRegion: null === (c = v) || void 0 === c ? void 0 : c.region,
            addressCountry:
              null === (s = v) || void 0 === s ? void 0 : s.country,
            postalCode:
              null === (o = v) || void 0 === o ? void 0 : o.postalCode,
            streetAddress:
              null === (m = v) || void 0 === m ? void 0 : m.streetAddress,
          },
          hasCredential: u,
        };
        return n.a.createElement(
          N.a,
          null,
          n.a.createElement("title", null, f.title),
              ...
              n.a.createElement(
                ...
                n.a.createElement(
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement(W, { fileName: t.fileName, theme: e })
                  )
                ),
                n.a.createElement(
                  "div",
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement(O, { logos: t.softwareSkills })
                  ),
                  n.a.createElement(
                    h.Fade,
      ...
      function ce(e) {
        return n.a.createElement(
          ...
          n.a.createElement(
            ...
            n.a.createElement(ie, { id: "logo", theme: e.theme })
          )
        );
      }
        ...
        render() {
          ...
          return n.a.createElement(
            ...
            n.a.createElement(
              ...
              u.degrees.map((t) =>
                n.a.createElement(de, { degree: t, theme: e })
              )
            )
          );
        }
        ...
        render() {
          ...
          return n.a.createElement(
            ...
            n.a.createElement(
              ...
              x.certifications.map((t) =>
                n.a.createElement(fe, { certificate: t, theme: e })
              )
            )
          );
        }
              ...
              n.a.createElement(
                ...
                n.a.createElement(
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement(ye, { logos: y.competitiveSites })
                  )
                )
              ),
              n.a.createElement(he, { theme: this.props.theme }),
              x.certifications.length > 0
                ? n.a.createElement(ge, { theme: this.props.theme })
                : null
            ),
            n.a.createElement(te, { theme: this.props.theme }),
            n.a.createElement(ae, { theme: this.props.theme })
      ...
      class Re extends l.Component {
        render() {
          ...
          return n.a.createElement(
            ...
            n.a.createElement(Ne, { sections: M.sections, theme: e }),
              ...
              n.a.createElement(
                ...
                n.a.createElement(
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement("img", {
                      src: a(24)("./".concat(Be.profile_image_path)),
                      alt: "",
                    })
                  ),
                  n.a.createElement(
        ...
        render() {
          ...
          return n.a.createElement(
            ...
            n.a.createElement(
              ...
              Te.data.map((t) => n.a.createElement(Ge, { repo: t, theme: e }))
            ),
            n.a.createElement(D, {
              text: "More Projects",
              className: "project-button",
              href: p.githubProfile,
              newTab: !0,
              theme: e,
            }),
            n.a.createElement(te, {
      ...
      var Ye = function () {
        return n.a.createElement(
          ...
          n.a.createElement(
            ...
            n.a.createElement("div", null, n.a.createElement(Oe, { theme: Pe }))
          )
        );
      };
      Boolean(
      ...
      i.a.render(
        n.a.createElement(
          o.a,
          { value: We },
          n.a.createElement(c.a, { theme: s.a }, n.a.createElement(Ye, null))
        ),
...
//# sourceMappingURL=main.1fa5d2ae.chunk.js.map
